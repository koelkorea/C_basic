...
int main()
{
    ...
    char* a = "array and pointer";          // char 포인터변수 a는 문자열 배열 "array and pointer"의 첫번째 문자 주소 저장
    ...
    printf("[문자열 입력 20개]\n");
    scanf_s("%s", d, (int)sizeof(d));       // 앞서 언급한 char 배열 d의 크기인 20만큼에 해당하는 문자열을 입력해서 d에 문자열을 입력해라
