...
//          - 3차원 array변수 자신 : 쓰레기주소값(= 단독으로 쓴 '3차원배열변수'는 진짜 3차원배열변수[0][0][0]와 어떤 연관관계도 찾을 수 없음)
//             -> 3차원 array변수 자신값이 쓰레기인 이유 : 다차원 배열의 시작 주소를 저장하고 있지만, 이 주소는 다차원 배열의 첫 번째 요소가 아니기 때문
